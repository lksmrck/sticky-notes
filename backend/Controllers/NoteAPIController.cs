...
namespace backend.Controllers
{
    ...
    public class NoteAPIController : ControllerBase
    {
        ...
        public NoteAPIController(ApplicationDbContext db, INoteRepository dbNote)
        {
        ...
        public async Task<ActionResult<APIResponse>> PostNote([FromBody] Note note)
        {
            try
            {
                if (await _dbNote.GetAsync(u => u.Heading.ToLower() == note.Heading.ToLower()) != null)
                {
